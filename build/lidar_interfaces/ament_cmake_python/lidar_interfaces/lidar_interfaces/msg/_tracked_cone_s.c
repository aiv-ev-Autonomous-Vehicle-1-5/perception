...
bool lidar_interfaces__msg__tracked_cone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lidar_interfaces.msg._tracked_cone.TrackedCone", full_classname_dest, 46) == 0);
  }
  lidar_interfaces__msg__TrackedCone * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrackedCone */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lidar_interfaces.msg._tracked_cone");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedCone");
