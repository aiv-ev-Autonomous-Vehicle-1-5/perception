...
#ifndef LIDAR_INTERFACES__MSG__DETAIL__TRACKED_CONE__TRAITS_HPP_
#define LIDAR_INTERFACES__MSG__DETAIL__TRACKED_CONE__TRAITS_HPP_
...
inline std::string to_yaml(const TrackedCone & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const lidar_interfaces::msg::TrackedCone & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lidar_interfaces::msg::TrackedCone & msg)
{
  return lidar_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<lidar_interfaces::msg::TrackedCone>()
{
  return "lidar_interfaces::msg::TrackedCone";
}

template<>
inline const char * name<lidar_interfaces::msg::TrackedCone>()
{
  return "lidar_interfaces/msg/TrackedCone";
}

template<>
struct has_fixed_size<lidar_interfaces::msg::TrackedCone>
...
template<>
struct has_bounded_size<lidar_interfaces::msg::TrackedCone>
...
template<>
struct is_message<lidar_interfaces::msg::TrackedCone>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // LIDAR_INTERFACES__MSG__DETAIL__TRACKED_CONE__TRAITS_HPP_
