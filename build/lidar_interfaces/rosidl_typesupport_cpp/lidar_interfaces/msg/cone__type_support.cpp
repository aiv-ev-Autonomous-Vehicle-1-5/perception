...
static const _Cone_type_support_symbol_names_t _Cone_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_interfaces, msg, Cone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_interfaces, msg, Cone)),
  }
};
...
get_message_type_support_handle<lidar_interfaces::msg::Cone>()
{
  return &::lidar_interfaces::msg::rosidl_typesupport_cpp::Cone_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lidar_interfaces, msg, Cone)() {
  return get_message_type_support_handle<lidar_interfaces::msg::Cone>();
}
