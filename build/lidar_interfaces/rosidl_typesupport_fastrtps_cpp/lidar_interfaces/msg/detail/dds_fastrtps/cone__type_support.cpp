...
#include "lidar_interfaces/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lidar_interfaces::msg::Cone & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lidar_interfaces::msg::Cone & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lidar_interfaces::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lidar_interfaces::msg::Cone *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_interfaces::msg::Cone *>(
    untyped_ros_message);
...
{
  return &lidar_interfaces::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_interfaces, msg, Cone)() {
  return &lidar_interfaces::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
