...
#include "lidar_interfaces/msg/detail/cone_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const lidar_interfaces::msg::Cone &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  lidar_interfaces::msg::Cone &);
size_t get_serialized_size(
  const lidar_interfaces::msg::Cone &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: cones
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lidar_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Cone(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = lidar_interfaces::msg::ConeArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lidar_interfaces::msg::ConeArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_interfaces::msg::ConeArray *>(
    untyped_ros_message);
...
{
  return &lidar_interfaces::msg::typesupport_fastrtps_cpp::_ConeArray__handle;
}
