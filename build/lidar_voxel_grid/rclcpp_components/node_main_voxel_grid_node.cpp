...
#define NODE_MAIN_LOGGER_NAME "voxel_grid_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvoxel_grid_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lidar_voxel_grid::VoxelGridComponent>";
