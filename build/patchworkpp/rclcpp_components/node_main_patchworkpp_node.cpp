...
#define NODE_MAIN_LOGGER_NAME "patchworkpp_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgseg_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<patchworkpp_ros::GroundSegmentationServer>";
