...
: ${AMENT_CURRENT_PREFIX:="/home/aiv/ev_ws/perception/install/lidar_tracking"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_tracking/environment/library_path.sh"
